...
Консольная утилита, которая автоматически билдит проект, подключается к VDS и копирует папку с готовым билдом на сервер
...
В папке /home/your_username/ создаем конфиг для сервера:
